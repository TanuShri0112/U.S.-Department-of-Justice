        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="siteName" defaultValue="Corporación Municipal de Desarrollo Social de Antofagasta" />
            </div>
            <div className="space-y-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="emailFooter" defaultValue="© 2025 Corporación Municipal de Desarrollo Social de Antofagasta. All rights reserved." />
            </div>
