...
const EvaluationFeedback = () => {
  ...
  const getMockData = (t) => ({
    surveys: {
      ...
      totalResponses: 1247,
      recentResponses: [
        { id: 1, course: t('uqtrTrainingCatalogue'), rating: 4.5, date: '2024-01-15', feedback: t('excellentCourseContent') },
        { id: 2, course: t('uqtrSelfRegistration'), rating: 4.0, date: '2024-01-14', feedback: t('veryHelpfulUnderstanding') },
        { id: 3, course: t('uqtrProgressTracking'), rating: 4.8, date: '2024-01-13', feedback: t('outstandingProgramRealWorld') }
      ]
    },
    selfAssessments: {
