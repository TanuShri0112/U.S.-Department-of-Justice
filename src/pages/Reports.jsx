...
const Reports = () => {
  ...
  const exportToPDF = () => {
    try {
      ...
      // Footer
      doc.setFontSize(8);
      doc.text('Generated by Corporación Municipal de Desarrollo Social de Antofagasta Training System', 20, doc.internal.pageSize.height - 20);
      ...
      try {
        ...
        fallbackDoc.text('Generated by Corporación Municipal de Desarrollo Social de Antofagasta', 20, 150);
