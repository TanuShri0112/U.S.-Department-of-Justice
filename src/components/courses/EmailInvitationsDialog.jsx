...
export const EmailInvitationsDialog = ({ open, onOpenChange, courseId }) => {
  const [organization, setOrganization] = useState('Corporación Municipal de Desarrollo Social de Antofagasta');
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select value={organization} onValueChange={setOrganization}>
                ...
                <SelectContent>
                  <SelectItem value="Corporación Municipal de Desarrollo Social de Antofagasta">Corporación Municipal de Desarrollo Social de Antofagasta</SelectItem>
