...
const navItems = [
  {
    icon: Home,
    label: { en: 'Dashboard', uk: 'Панель' },
    href: '/',
    allowedRoles: null,
  },
  {
    icon: BookOpen,
    label: { en: 'Courses', uk: 'Курси' },
    href: '/courses',
    allowedRoles: COURSE_ROLES,
  },
  {
    icon: Users,
    label: { en: 'Groups', uk: 'Групи' },
    href: '/groups',
    allowedRoles: GROUP_ROLES,
  },
  {
    icon: Calendar,
    label: { en: 'Calendar', uk: 'Календар' },
    href: '/calendar',
    allowedRoles: GROUP_ROLES,
  },
  {
    icon: Bell,
    label: { en: 'Announcements', uk: 'Оголошення' },
    href: '/announcements',
  ...
  {
    icon: Video,
    label: { en: 'Webinars', uk: 'Вебінари' },
    href: '/webinars',
    allowedRoles: COURSE_ROLES,
  },
  {
    icon: MessageSquare,
    label: { en: 'Messages', uk: 'Повідомлення' },
    href: '/messages',
    allowedRoles: COMMUNICATION_ROLES,
  },
  {
    icon: HelpCircle,
    label: { en: 'Help', uk: 'Допомога' },
    href: '/help',
    allowedRoles: null,
  }
];
          ...
          className={({ isActive }) =>
            cn(
              ...
              isActive
                ...
                : 'text-[hsl(var(--sidebar-foreground))] hover:bg-[hsl(var(--sidebar-hover))] hover:text-[hsl(var(--sidebar-accent))]'
            )
          }
        >
